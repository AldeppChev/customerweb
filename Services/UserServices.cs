...
namespace Services
{
    public interface IUserService
    {
        ...
        void Update(Customer user, string currentPassword, string password, string confirmPassword);
        void Delete(int id);
    }
    ...
    public class UserService : IUserService
    {
        ...
        public void Update(Customer userParam, string currentPassword = null, string password = null, string confirmPassword = null)
        {
            //Find the user by Id
